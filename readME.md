...
- **ETL Notebooks:**
    ...
    - **port_coordinates.ipynb**: Additional notebook that cleans an external datasheet for the coordinates of most of the ports in the data. 
...
- **SQL Queries:**
    ...
    - **making_view_quieries.sql**: For our use case, 8 views were made so that there could be a variety in the amount of data being displayed. You can check out the code for the views made in this file!
